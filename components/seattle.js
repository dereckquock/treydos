...
import { asset, Pano, View, Text } from 'react-vr'
...
And the popcorn was delicious!`
    ...
    return (
      <View>
        ...
        <BouncingText text={text} transform={[{ translate: [0, 0, -2] }]} />

        <BouncingText
          text={'We even bought Seahawks gear to fit in :P'}
          style={{ width: 1, fontSize: 0.05 }}
          transform={[{ translate: [0, 0, -1.5] }, { rotateX: '-45deg' }]}
          delay={100}
        />

        <Football
          layoutOrigin={[0.5, 0.5]}
          transform={[{ translate: [-1.5, 0, -1] }, { rotateY: '60deg' }]}
        >
          <Text
            style={[
              styles.text,
